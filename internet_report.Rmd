...
font_add("Montserrat", "72331_GLP_A Path Forward_web header_v2_Folder/72331_GLP_A Path Forward_web header_v2_Folder/Fonts/Montserrat-Regular.ttf")
font_add("Montserrat Bold", "72331_GLP_A Path Forward_web header_v2_Folder/72331_GLP_A Path Forward_web header_v2_Folder/Fonts/Montserrat-SemiBold.ttf")
...
### No District labels
```{r, message = FALSE}
map_district <- st_read("Council_Districts", quiet =T)
child_internet <- read_csv("child_internet.csv", col_types = "nnnn")
